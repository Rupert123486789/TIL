...
* **반복문의 종류와 특징**
  ...
  * for ... of
    * **💥반복 가능한(iterable) 객체를 순회**하며 값을 꺼낼때 사용
...
* **객체의 정의와 특징**
  ...
  * ![image-20220501154417038](javascript_basic.assets/image-20220501154417038.png)
...
* **객체와 메서드**
  ...
  * ![image-20220501154548698](javascript_basic.assets/image-20220501154548698.png)
...
* **객체 관련 ES6 문법 (1) - 속성명 축약(shorthand)**
  ...
  * ex.
    * ![image-20220501154819602](javascript_basic.assets/image-20220501154819602.png)
...
* **객체 관련 ES6 문법 (2) - 메서드명 축약(shorthand)**
  ...
  * ex.
    * ![image-20220501154926825](javascript_basic.assets/image-20220501154926825.png)
...
* **객체 관련 ES6 문법 (3) - 계산된 속성(computed property name)**
  ...
  * ex.
    * ![image-20220501155038898](javascript_basic.assets/image-20220501155038898.png)
...
* **객체 관련 ES6 문법 (4) - 구조 분해 할당(destructing assignment)**
  ...
  * ex.
    * ![image-20220501155157226](javascript_basic.assets/image-20220501155157226.png)
  * 함수의 매개변수에서 구조 분해 할당을 해서 받을때 빛을 발함
  * 💥구조 분해 할당은 함수에서 매개변수로 넘겨줄 때와 import 구문에서 자주 쓰임
...
* **객체 관련 ES6 문법 (5) - Spread operator**
  ...
  * 얕은 복사에 활용 가능
    * ![image-20220501155318164](javascript_basic.assets/image-20220501155318164.png)
...
* **JSON(JavaScript Object Notation)**
  ...
  * 자바스크립트에서는 JSON을 조작하기 위한 두 가지 내장 메서드를 제공
    ...
    * JSON.stringify()
      * 자바스크립트 객체 => JSON
  * ex.
    * ![image-20220501155705534](javascript_basic.assets/image-20220501155705534.png)
...
* **(참고) 배열은 객체다**
  ...
  * ![image-20220501155826741](javascript_basic.assets/image-20220501155826741.png)
...
* **this is window? object?**(✨python의 self와 비슷하지만 python은 명시적)
  * JS의 this는 실행 문맥(execution context)에 따라 다른 대상을 가리킴.
  * class 내부의 생성자(constructor) 함수 
    * this는 생성되는 객체를 가리킴(Python의 self)
  * 메서드(객체.메서드명()으로 호출 가능한 함수) = > 💥**.을 찍고 할 수 있는 모든 함수**
    * this는 해당 메서드가 소속된 객체를 가리킴
  * 위의 두가지 경우를 제외하면 모두 최상위 객체(window)를 가리킴(✨window를 가리킬 때는 쓸 이유가 없음).
  * ![image-20220501160031487](javascript_basic.assets/image-20220501160031487.png)
...
* **function 키워드와 화살표 함수 차이**
  ...
  * ✨때문에 콜백함수 내부의 this는 whindow가 되어 this.PI는 정상적으로 접근 불가능 
    * ✨내부에 있는 콜백 함수는 메서드로 부를 수 없음
  * 이 콜백함수 내부에서 this.PI에 접근하기 위해서 함수객체.bind(this) 메서드를 사용
  * 이 번거로운 bind 과정을 없앤 것이 화살표 함수
  * ![image-20220501160227969](javascript_basic.assets/image-20220501160227969.png)
  * Summary(✨**함수 내에 this가 있을 때는 집중!**)
...
* **사용 예시**
  * ![image-20220501160628744](javascript_basic.assets/image-20220501160628744.png)
  * ![image-20220501160700540](javascript_basic.assets/image-20220501160700540.png)
